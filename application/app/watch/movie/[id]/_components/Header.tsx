...
function Text({ budget, genres, overview, release_date, revenue, runtime, tagline, title, typesStream, credits, pegi }: TextProps) {
...
export default function Header({ backdrop_path, budget, genres, overview, poster_path, release_date, revenue, runtime, tagline, title, typesStream, credits, pegi }: HeaderProps) {
                ...
                <div className="flex justify-center flex-wrap" style={{ backgroundImage: "linear-gradient(to right, rgba(50, 50, 50, 1) calc((50vw - 170px) - 340px), rgba(50, 50, 50, 0.84) 50%, rgba(50, 50, 50, 0.84) 100%)" }}>
                    <div className="w-full max-w-[1400px] px-10 py-[30px] z-0">
                        <section className="flex flex-nowrap text-white">
                            ...
                            <Text budget={budget} genres={genres} overview={overview} release_date={release_date} revenue={revenue} runtime={runtime} tagline={tagline} title={title} typesStream={typesStream} credits={credits} pegi={pegi} />
                        </section>
                    </div>
                </div>
            </div>
