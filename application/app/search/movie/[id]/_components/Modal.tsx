...
export default function MyModal({movieApi, movieDb, callFetching, parentFunction, hideModal}: MyModalProps) {
    useEffect(() => {
    ...
    const modalTitle: string = movieDb ? "Modifier ce film" : "Ajouter ce film";
                ...
                <div className="relative w-full max-w-2xl max-h-full">
                    <div className="relative bg-white rounded-lg shadow">
                        ...
                        <div className="p-6 space-y-6">
                            <Forms movieApi={movieApi} movieDb={movieDb} callFetching={callFetching}
                                   hideModal={hideModal}/>
                        </div>
                        <div className="flex items-center justify-end p-6 space-x-2 border-t border-gray-200 rounded-b">
                            <ButtonsGroup isInDb={movieDb !== undefined} hideModal={hideModal}/>
                        </div>
                    </div>
                </div>
            </div>
