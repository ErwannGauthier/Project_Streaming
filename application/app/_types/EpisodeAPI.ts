...
export interface EpisodeAPIObject {
    air_date: string;
...
export class EpisodeAPI {
    ...
    static getInstance(object: EpisodeAPIObject): EpisodeAPI {
        ...
        return new EpisodeAPI(airDate, episodeNumber, episodeType, id, name, overview, productionCode, runtime, seasonNumber, showId, stillPath, voteAverage, voteCount, crew, guestStars);
    }
